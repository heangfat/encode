...
const 純訛 = ['鳳鳯','派沠','虐䖈䨋','屆届㧂','蒙䝉','俎爼','步歨','邊邉','微㣲','輒輙','究䆒','土圡','篡簒','寇宼窛','賫賷','髡髠','肉宍','肻肯','霸覇','遟遅','夢夣','渫㳿','捷㨗掶','枣栆','鬮䰗䦰阄','丑丒','昂昻',
...
const 隸定不同 = ['宿㝛','弼弻','旁㫄','榜㮄','貴䝿贵','眉睂','齊亝斉','濟㴉済','躋䠁','劑剤','纃緕','薺萕','儕㑪','擠㨈','原厡','年秊','展㞡','禼卨','款歀','隸隷'];

/* 筆畫稍訛，而部件變化，致理據重構，而音義不變。雖非宂碼，卻亦影響搜索。 */
const 稍訛重構 = ['溫温','媼媪','慍愠','搵揾','氳氲','縕緼缊','蘊藴蕴','榲榅','熅煴','膃腽','蒕蒀','薀蕰','轀輼辒','醞醖','鰮鰛鳁',
'改攺','罵駡','衋䀌','鬱鬰欎欝','謚諡谥','輩軰','寛寬','柹柿','遟遲','夜亱',
