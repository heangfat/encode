...
const 純訛 = ['污汚','閏閠闰','鳳鳯','派沠','虐䖈䨋','屆届㧂','蒙䝉','俎爼','步歨','邊邉','微㣲','輒輙','究䆒','土圡','篡簒','寇宼窛','賫賷','髡髠','肉宍','肻肯','霸覇','遟遅','夢夣','渫㳿','捷㨗掶','枣栆','鬮䰗䦰阄','丑丒','昂昻','刱剙剏','往徃','凬凮','釜釡','出岀','乾乹亁','媲嫓','曌瞾','丘丠',
'寧寜寕','甯寗','繼継继','斷㫁断','卻却','腳脚','賴頼','瀨瀬','戾戻','淚涙','策䇿筞萗','刺㓨刾','幣幤','弊㢢','廉亷㢘','濂濓','鐮䥥镰','銜衘䘖','㘅㗸','禿秃','頹頺頽颓','函凾','涵㴠',
'祕秘','穎頴颕','稟禀','凜凛','廩廪','懍懔','檁檩','燣燷','癛癝',
'柳桺','駠駵',
'留畱','榴橊','溜澑','瑠璢','瘤癅','籀籒','罶羀','鎦鐂','飀飅','騮驑','塯㙧','㨨㩅',
'朁㬱','潛濳潜','簪簮','鐕鐟','譖譛','䣟䣠','僭僣','憯㦧',
'鶪鵙䴗','思恖','顋顖',
'韱韯','懺懴','殲殱','瀸瀐','籤籖','纖纎','攕㩥','櫼㰇','䃸䃱','䘋䘂','讖䜟',
'悤怱','傯偬','憁愡','摠揔㹅','樬楤','牕牎','總緫','聰聦','蔥葱','鏓鍯,','驄騘','熜㷓','窻䆫','蟌䗓'];

const 隸定不同 = ['汙汚','玨珏','宿㝛','弼弻','旁㫄','榜㮄','貴䝿贵','眉睂','齊亝斉','濟㴉済','躋䠁','劑剤','纃緕','薺萕','儕㑪','擠㨈','原厡','年秊','展㞡','禼卨','款歀','隸隷','折㪿','冀兾','兔兎','丘㐀',
'函圅','菡䓿','䤴䥁'];
