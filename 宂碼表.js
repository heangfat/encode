...
'彔录','綠緑绿','錄録','剝剥','淥渌','祿禄',
'彝彞','彜彛','彙彚','緣縁缘','緒緖绪',
'敳敱','敆㪉','敲㪣','敘敍','漵潊','强強','繦繈',
'晚晩','走赱','步歩','涉渉','复㚆','番畨','樣様','密宻',
'舉擧','櫸欅','攑㩮',
'遙遥','搖摇揺','瑤瑶','謠謡谣',
'艷艶','灧灔','灩灎',
...
'叟叜','搜捜摉','廋廀','瘦痩','嫂㛮','艘䑹','螋䗏','醙䤇','鎪䤹','颼䬒','騪䮟',
'罕䍐䍑','罭䍞','更㪅','綆䌄','從従徔','縱縦',
...
'勻匀','教敎','壽夀','黑黒','曾曽','增増','會㑹会','每毎','吞呑','坍㘱',
'枏柟','耼聃','蚦蚺','衻袡','髥髯','㚩姌','䑙舑','䒣苒',
'卮巵','栀梔',
'犮叐','拔㧞抜','跋䟦','髮髪',
'看㸔','事叓亊㕝','史㕜','堇菫','巺㢲','徵徴','備僃俻'];// 偹

const 純訛 = ['污汚','閏閠闰','鳳鳯','派沠','虐䖈䨋','屆届㧂','蒙䝉','俎爼','步歨','邊邉','微㣲','輒輙','究䆒','土圡','篡簒','寇宼窛','賫賷','髡髠','肉宍','肻肯','霸覇','遟遅','夢夣','渫㳿','捷㨗掶','枣栆','鬮䰗䦰阄','丑丒','昂昻','刱剙剏','往徃','凬凮','釜釡','出岀','乾乹亁','媲嫓','曌瞾','丘丠','緐䋣','遞逓','惪恴',
'寧寜寕','甯寗','繼継继','斷㫁断','卻却㕁','腳脚','郤郄','賴頼','瀨瀬','戾戻','淚涙','策䇿筞萗','刺㓨刾','幣幤','弊㢢','廉亷㢘','濂濓','鐮䥥镰','銜衘䘖','㘅㗸','禿秃','頹頺頽颓','函凾','涵㴠',
...
const 隸定不同 = ['汙汚','玨珏','宿㝛','弼弻','旁㫄','榜㮄','貴䝿贵','眉睂','齊亝斉','濟㴉済','躋䠁','劑剤','纃緕','薺萕','儕㑪','擠㨈','原厡','年秊','展㞡','禼卨','款歀','隸隷','折㪿','冀兾','兔兎','丘㐀','是昰','虎乕',
'函圅','菡䓿','䤴䥁'];

/* 筆畫稍訛，而部件變化，致理據重構，而音義不變。雖非宂碼，卻亦影響搜索。 */
const 稍訛重構 = ['溫温','媼媪','慍愠','搵揾','氳氲','縕緼缊','蘊藴蕴','榲榅','熅煴','膃腽','蒕蒀','薀蕰','轀輼辒','醞醖','鰮鰛鳁',
'攺改','罵駡','衋䀌','鬱鬰欎欝','謚諡谥','輩軰','寛寬','柹柿','遟遲','夜亱','庶庻','㓝刑','恥耻','誄䛶','巹卺','旨㫖',
