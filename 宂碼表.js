...
'罕䍐䍑','罭䍞','更㪅','綆䌄','從従徔','縱縦',
'或㦯','斝斚','面靣','回囬','廻廽','迴逥','蛔蜖','圖圗图図','員貟员贠','圓圎圆円','松柗','船舩','拘抅','鉤鈎','肙䏍','娟姢','涓㳙','琄㻆','鵑䳌鹃','雄䧺','統綂统',
'沒没','歿殁','疐㚄','嚏嚔',
'恆恒','揯搄','緪縆','䱍䱎','䱭䱴',
'尔尒尓','你伱','鉨鉩鈢','妳㚷',
'賓賔','濱濵','檳㯽',
...
const 純訛 = ['閏閠闰','鳳鳯','派沠','虐䖈䨋','屆届㧂','蒙䝉','俎爼','步歨','邊邉','微㣲','輒輙','究䆒','土圡','篡簒','寇宼窛','賫賷','髡髠','肉宍','肻肯','霸覇','遟遅','夢夣','渫㳿','捷㨗掶','枣栆','鬮䰗䦰阄','丑丒','昂昻','刱剙剏','往徃','凬凮','釜釡','出岀','乾乹亁','媲嫓',
'寧寜寕','甯寗','繼継继','斷㫁断','卻却','腳脚','賴頼','瀨瀬','戾戻','淚涙','策䇿筞萗','刺㓨刾','幣幤','弊㢢','廉亷㢘','濂濓','鐮䥥镰','銜衘䘖','㘅㗸',
...
const 隸定不同 = ['玨珏','宿㝛','弼弻','旁㫄','榜㮄','貴䝿贵','眉睂','齊亝斉','濟㴉済','躋䠁','劑剤','纃緕','薺萕','儕㑪','擠㨈','原厡','年秊','展㞡','禼卨','款歀','隸隷','折㪿','冀兾','兔兎'];

/* 筆畫稍訛，而部件變化，致理據重構，而音義不變。雖非宂碼，卻亦影響搜索。 */
const 稍訛重構 = ['溫温','媼媪','慍愠','搵揾','氳氲','縕緼缊','蘊藴蕴','榲榅','熅煴','膃腽','蒕蒀','薀蕰','轀輼辒','醞醖','鰮鰛鳁',
'攺改','罵駡','衋䀌','鬱鬰欎欝','謚諡谥','輩軰','寛寬','柹柿','遟遲','夜亱','庶庻','㓝刑','恥耻',
