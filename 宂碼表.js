...
'青靑','清淸',
'真眞','填塡','顛顚','巔巓','慎愼','槙槇','鎮鎭镇','鷏鷆','值値','惪悳'/*㥁*/,'俱倶',
'彔录','綠緑绿','錄録','剝剥','淥渌','祿禄',
'緣縁缘','緒緖绪',
'敘敍','漵潊','强強','繦繈',
'晚晩','走赱','番畨',
...
'罕䍐䍑','罭䍞',
'或㦯','斝斚','面靣','回囬','廻廽','迴逥','蛔蜖','圖圗图図','員貟员贠','圓圎圆円',
'沒没','歿殁',
'尔尒尓','你伱','鉨鉩鈢','妳㚷',
'參叅㕘参','別别','戶戸户','遠逺','藝兿','歴厯','卯戼','埒埓','熙煕熈㷩','萸茰','查査',
'教敎','壽夀','曾曽','增増','會㑹会','每毎','吞呑','坍㘱',
'犮叐','拔㧞抜','跋䟦','髮髪',
'閏閠闰','玨珏'];

const 純訛 = ['鳳鳯','派沠','虐䖈䨋','屆届㧂','祕秘',
'寧寜寕','甯寗'];
